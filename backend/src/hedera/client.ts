...
export const treasuryAccountId = AccountId.fromString(config.hedera.treasuryAccountId);
export const treasuryKey = PrivateKey.fromStringECDSA(config.hedera.treasuryKey);
